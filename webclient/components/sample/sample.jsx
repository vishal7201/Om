        ...
        >
          ...
          <SubMenu key="directMessages" disabled title={<div><span><Icon type="appstore" /><span>DIRECT MESSAGES</span></span><Icon type="plus-circle" /></div>}>
            ...
            <Menu.Item key="6">vishal_bisht(you)</Menu.Item>
					...
					<div>
					<Affix style={{'margin-left':'255px'}}  offsetBottom={10}>
						<Input addonBefore={<Icon style={{width:'44px'}} type="plus" />} addonAfter={<Icon style={{width:'44px'}} type="smile" />} style={{height:'43px'}}  placeholder="Message yourself"/>
					</Affix>
				</div>
      </div>
    );
